...
async function startServer() {
  ...
  app.post("/api/wavespeed/image", async (req, res) => {
    try {
      ...
      // Use dynamic import for Wavespeed SDK since it's ESM/CommonJS mixed sometimes, or just use fetch
      // Actually, let's just use fetch to Wavespeed API to avoid SDK issues on backend
      // Wait, the SDK `wavespeed` is installed. Let's use it.
